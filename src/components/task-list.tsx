    ...
    return (
        <>
            ...
            <div className="sticky top-0 z-10 pointer-events-none">
                ...
                <div className='bg-background/50 backdrop-blur-sm px-4 pt-4 pb-2 pointer-events-auto'>
                    <QuickAddTask
                ...
                <div className='h-6 bg-gradient-to-b from-background/50 to-transparent'></div>
            </div>
